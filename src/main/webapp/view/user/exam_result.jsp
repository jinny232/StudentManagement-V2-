            ...
            <nav class="navbar navbar">
                ...
                <div class="navbar-nav w-100">
                  <a href="profile.jsp" class="nav-item nav-link"><i class="fa fa-user me-2"></i>Profile</a>
                    ...
                    <a href="exam_result.jsp" class="nav-item nav-link active"style=" box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"><i class="fas fa-newspaper me-2"></i>Exam Result</a>
...
<nav class="navbar navbar-expand bg-info navbar-dark sticky-top px-2 py-0">
  ...
  <div class="navbar-nav align-items-center ms-auto">
      <div class="nav-item dropdown input-group">
          ...
          <select name="year" id="year" class="form-select form-control">
           ...
           <option value="firth">Firth Year</option>
		 ...
		 $.ajax({
			 ...
			 success:function(response){
				 ...
				 if(response.posts.length==0){
					 $("#post_container").html(`<div class="text-center mt-5"><h3>Nothing Searching</h3></div>`);
				 }else{ 
					 $("#post_container").html("");
